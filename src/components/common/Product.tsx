...
export default function Product({
  ...
  return (
    <div
      className="h-[260px] md:h-[360px] lg:h-[420px] w-[180px] md:w-[230px] lg:w-[280px] flex flex-col justify-between items-center gap-2 rounded-[10px] p-6 hover:bg-gray-100 "
    >
      ...
      <div className="w-full flex flex-col items-center justify-start gap-1 lg:gap-2">
        <h3 title={name} className="font-bold text-[16px] lg:text-[24px] leading-[24.2px] lg:leading-[29.05px]">
      ...
      <div className="w-full flex flex-col items-center justify-start gap-2">
        ...
        >
          <button
            className="w-[128px] md:w-[160px] lg:w-[220px] h-[34px] md:h-[40px] lg:h-[50px] rounded-[10px] bg-[var(--primary)] font-bold text-white text-[14px] lg:text-[16px] leading:[16.94px] md:leading-[19.36px] active:opacity-95 active:scale-95
